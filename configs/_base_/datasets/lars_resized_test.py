...
data_root = '/home/user/workspaces/mmseg_lars_ws/lars_resized/'# TODO: change this to your own path
ignore_idx=255
img_norm_cfg = dict(
...
dataset_type = 'LaRSDataset'
data_root = '/home/user/workspaces/mmseg_lars_ws/lars_resized/'
...
train_dataloader = dict(batch_size=260,
                        num_workers=4,
